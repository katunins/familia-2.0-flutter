...
class FreeScrollView extends StatefulWidget {
  ...
  const FreeScrollView({Key? key, this.physics = const ClampingScrollPhysics(), required this.child})
      : super(key: key);
...
class _FreeScrollViewState extends State<FreeScrollView> {
  ...
  void _handleDragEnd(DragEndDetails details) {
    _horizontalDrag?.end(
        DragEndDetails(velocity: details.velocity, primaryVelocity: details.velocity.pixelsPerSecond.dx));
    _verticalDrag?.end(
        DragEndDetails(velocity: details.velocity, primaryVelocity: details.velocity.pixelsPerSecond.dy));
  }
