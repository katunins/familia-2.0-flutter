...
import 'package:familia_flutter/components/common/userPic.dart';
...
class CustomAppBar extends StatelessWidget {
  ...
  Widget get titleWidget {
    if (searchBarStore != null) {
      return Flexible(child: AppBarInput(
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [const AutoLeadingButton(), titleWidget, Opacity(opacity: opacity, child: const UserPic(),)],
        ),
      ),
    );
  }
