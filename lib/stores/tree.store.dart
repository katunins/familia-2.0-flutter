...
abstract class TreeStoreBase with Store {
  ...
  //
  //   if (xRootCenter != null && leftElementCenter != null && rightElementCenter != null) {
  ...
  @observable
  Map<String, GlobalKey> elementKeys = ObservableMap<String, GlobalKey>.of({});
  ...
  @computed
  double get userPicSize => AppSizes.userPicSize;

  @computed
  double get treeElementHeight => 133;

  @computed
  double get paddingBetween => 10;
